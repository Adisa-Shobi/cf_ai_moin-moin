import { FileCode, FileText, TerminalWindow } from "@phosphor-icons/react";
...
export function ContextPanel({ files }: ContextPanelProps) {
  ...
  return (
    <div className="h-full flex flex-col border-l border-neutral-300 dark:border-neutral-800 bg-white dark:bg-neutral-950">
      {/* Tabs Header */}
      <div className="flex items-center border-b border-neutral-300 dark:border-neutral-800 bg-neutral-100 dark:bg-neutral-900 overflow-x-auto no-scrollbar">
        {files.map((file) => (
          <button
          type="button"
            key={file.id}
